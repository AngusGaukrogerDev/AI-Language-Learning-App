        ...
        <div className='top-0 flex flex-col justify-center items-center gap-3 w-3/4 xl:w-1/2 text-center'>
          ...
          <div className='w-full flex flex-row justify-center items-center gap-3 xl:gap-5'>
              ...
              <Link legacyBehavior href="/sign-up" as="/sign-up" >
                  <button className=" bg-pitahaya-white text-pitahaya-black border-pitahaya-black border-1 px-4 py-2  rounded-md w-36 sm:w-56 md:w-56 h-14 flex flex-col justify-center items-center  hover:cursor-pointer transition duration-300 transform hover:scale-110">
                      <h3>Sign Up</h3>
                  </button>                  
              </Link>
          </div>

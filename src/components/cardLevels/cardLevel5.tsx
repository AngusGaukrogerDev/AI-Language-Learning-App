...
const CardLevel5: React.FC<CardLevel5Props> = ({ cardData, onIndexChange }) => {
  ...
  return (
    <>
      <div className='my-1 mx-auto p-16 bg-white rounded-lg shadow-lg'>
        <p className='text-lg font-semibold'>LEVEL 5</p>
        ...
        {showCorrectAnswer && (
          <div className='mt-4'>
            <p className='text-red-500'>Incorrect! The correct answer is: "{cardData.spanishTranslation}"</p>
